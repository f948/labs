...
var message = "First time visited";
...
app.get('/lab6part3.html', function (req, res) {
	

	res.sendfile("lab6part3.html");
	
});

app.get('/lab7part1.html', function (req, res) {
	

		res.sendfile("lab7part1.html");
	
});

app.get('/lab7part2.html', function (req, res) {
	

		res.sendfile("lab7part2.html");
...
io.on('connection', function(socket){
	...
	socket.emit("getLastDate",message);
	
	socket.on("sendDate",function(lastDate){
		message="This is not the first time visited site"+"\n"+"The last time visited is "+lastDate;
	});
